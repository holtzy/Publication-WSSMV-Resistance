...
We are going to study the 2 phenotypes for which we have data in 2012 and 2015.
...
# Symptom Severity (SS) - NO Blup normalization
...
```{r aavsg, results='asis' , echo=FALSE}
print(xtable(to_print), type = "html", include.rownames = F , comment=FALSE)
```
...
```{r addhh, results='asis' , echo=FALSE}
print(xtable(to_print), type = "html", include.rownames = F , comment=FALSE)
```
